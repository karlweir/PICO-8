	...
	if #dtb_queu>0 then
		...
		for i=1,dislineslength do
		 -- set text colour at end of this line
			print(dtb_dislines[i],4,i*8+60-(dislineslength+offset)*8,4)
		end
	end
end
...
function dialoguerun()
 if score == 1 then
  dtb_disp("you've colected 15!")
  dtb_disp("...of whatever those things are...")
  dtb_disp("petals maybe?")
  dtb_disp("collect collect collect more.")
  dtb_disp("maybe it'll truely make you happy :)")
 end
 if score == 40 then
  dtb_disp("have you tried going a pressing \U0001f17e\ufe0f at that wise old tree there?")
...

...
4444f4444444f4440444f444004fff4004000040000000040000000400400044004ff0440444ff404444f4404444f444000000004444f4444f4ff4f44f4ff4f4
...

__label__
...

